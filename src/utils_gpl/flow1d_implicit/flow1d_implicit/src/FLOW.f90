...
1010 continue
!c      ibuf2 = ibuf(2)
!c      do 1020 igrid = 1 , ngrid
!c         solbuf(ibuf2,1,igrid) = hp(igrid,3)
!c         solbuf(ibuf2,2,igrid) = qp(igrid,3)
!c         solbuf(ibuf2,3,igrid) = hp(igrid,3)-psltvr(5,igrid)
!c         solbuf(ibuf2,4,igrid) = waoft(igrid,1)
!c         solbuf(ibuf2,5,igrid) = waoft(igrid,2)
!c         solbuf(ibuf2,6,igrid) = 1/waoft(igrid,8)
1020 continue
!c
...
!         call sre_error (juer,'FLOW timestep@'//txt//'@',eflmes,info)
