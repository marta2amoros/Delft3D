...
module fm_external_forcings
   ...
   public :: addtimespacerelation_boundaries, allocate_patm, allocate_pseudo_air_pressure, allocate_water_level_correction
   public :: ini_alloc_laterals, init_registered_items, init_threttimes, print_error_message
   public :: quantity_pli_combination_is_registered, register_quantity_pli_combination, select_wave_variables_subgroup
