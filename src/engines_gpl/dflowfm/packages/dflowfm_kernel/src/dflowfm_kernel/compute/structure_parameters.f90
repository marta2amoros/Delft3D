...
contains
   ...
   subroutine structure_parameters
      ...
      use m_flow, only: dp, npumpsg, ngatesg, ncdamsg, ncgensg, ngategen, nweirgen, ngenstru, &
         aerr, dmiss, pumpswithlevels, l1pumpsg, l2pumpsg, kpump, l1gatesg, l2gatesg, &
         kgate, q1, s1, l1cdamsg, l2cdamsg, kcdam, l1cgensg, l2cgensg, kcgen, hu, &
         epshu, hs, epshs, gate2cgen, zcgen, weir2cgen, genstru2cgen
      use m_structures, only: numvals_pump, numvals_gate, numvals_cdam, numvals_cgen, &
         ...
         valweirgen, fill_valstruct_per_structure, valorifgen, valbridge, valculvert, &
         ival_cl_crestl, ival_cl_state, ival_cl_edgel, ival_cl_openh, valuniweir, &
         ival_uw_crestl, valdambreak, valgenstru, ival_openw, ival_edgel, ival_crestl, &
         valcmpstru, vallongculvert, average_valstruct, ival_crestw, ival_pp_cap, &
         ival_pp_disdir, ival_pp_stag, ival_pp_s1suc, ival_pp_s1del, ival_pp_head, ival_pp_red
